$(document).ready(function() {
  ...
  $("#getId").click(function() {
    $.getJSON(url, function(data) {
      ...
      var id = "0000".substring(0, 4 - aux.length) + aux;
      var codigo = codCent + codArt + id + "0";
  ...
  var centros = ["Administración de Servicios Centrales",
    ...
    "Centro de Servicios de Informática y Redes de Comunicación",
    ...
    "Colegio Mayor Isabel al Católica",
  ...
  function getCodCentro(nombre) {
    ...
    switch (nombre) {
      ...
      case "Centro de Instrumentación Cientifica":
        centro = "SUS26C";
        break;
      case "Centro de Instrumentación Científica":
        centro = "06CE01";
        break;
      ...
      case "Centro de Promoción de Empleo y Prácticas":
        centro = "06SA04";
        break;
      case "Centro de Servicios de Informática y Redes de Comunicación":
        centro = "06DIRIN";
        break;
      ...
      case "Colegio Mayor Garnata":
        centro = "0816MC";
        break;
      case "Colegio Mayor Isabel al Católica":
        centro = "SUS22G";
        break;
